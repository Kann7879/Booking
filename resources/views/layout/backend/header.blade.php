<nav
  ...
  <div class="navbar-nav-right d-flex align-items-center justify-content-end" id="navbar-collapse">
    ...
    <ul class="navbar-nav flex-row align-items-center ms-md-auto">
              ...
              <li class="list-group-item list-group-item-action dropdown-notifications-item">
                <div class="d-flex">
                  <div class="flex-shrink-0 me-3">
                    <div class="avatar">
                      <img 
                          src="{{ asset('assets/img/avatars/' . (Auth::user()->foto ?? 'no_image.jpg')) }}" 
                          alt="avatar" 
      ...
      <!-- Fullscreen -->
      <li class="nav-item">
        <a class="nav-link btn btn-icon btn-text-secondary rounded-pill" href="javascript:void(0);" id="btn-fullscreen">
          <i class="icon-base ri ri-fullscreen-line icon-22px"></i>
        </a>
      </li>
      <!-- /Fullscreen -->
      ...
      <li class="nav-item navbar-dropdown dropdown-user dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end mt-3 py-2">
          ...
          <li>
            <a class="dropdown-item" href="{{ route('acount.index') }}">
