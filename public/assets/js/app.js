...
if ("connection" in navigator) {
    let netSpeed = navigator.connection.downlink; // Mbps
    let loaderText = document.getElementById("loader-text");
    let loader = document.querySelector(".loader");

    if (netSpeed < 1) {
        loader.style.borderTopColor = "#e74c3c"; // merah kalau lambat
        loaderText.innerText = "Jaringan lambat...";
        loader.style.animationDuration = "2s"; // lebih lambat
    } else if (netSpeed < 5) {
        loader.style.borderTopColor = "#f39c12"; // kuning
        loaderText.innerText = "Memuat...";
    } else {
        loader.style.borderTopColor = "#2ecc71"; // hijau
        loaderText.innerText = "Koneksi cepat!";
    }
}
